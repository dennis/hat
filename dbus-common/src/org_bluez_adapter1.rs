...
pub trait OrgBluezAdapter1 {
    ...
    fn set_discovery_filter(
        &self,
        properties: ::std::collections::HashMap<&str, arg::Variant<Box<arg::RefArg>>>,
    ) -> Result<(), Self::Err>;
...
impl<'a, C: ::std::ops::Deref<Target = dbus::Connection>> OrgBluezAdapter1
    for dbus::ConnPath<'a, C>
{
    type Err = dbus::Error;
...
pub trait OrgFreedesktopDBusProperties {
    ...
    fn get<R0: for<'b> arg::Get<'b>>(
        ...
        interface: &str,
        name: &str,
    ) -> Result<arg::Variant<R0>, Self::Err>;
...
pub trait OrgBluezGattManager1 {
    ...
    fn register_application(
        ...
        options: ::std::collections::HashMap<&str, arg::Variant<Box<arg::RefArg>>>,
    ) -> Result<(), Self::Err>;
    fn unregister_application(&self, application: dbus::Path) -> Result<(), Self::Err>;
}

impl<'a, C: ::std::ops::Deref<Target = dbus::Connection>> OrgBluezGattManager1
    for dbus::ConnPath<'a, C>
{
    type Err = dbus::Error;
...
impl<'a, C: ::std::ops::Deref<Target = dbus::Connection>> OrgBluezLEAdvertisingManager1
    for dbus::ConnPath<'a, C>
{
    type Err = dbus::Error;
    ...
    fn register_advertisement(
        ...
        let mut m = self.method_call_with_args(
            &"org.bluez.LEAdvertisingManager1".into(),
...
impl<'a, C: ::std::ops::Deref<Target = dbus::Connection>> OrgBluezMedia1 for dbus::ConnPath<'a, C> {
    ...
    fn register_endpoint(
        ...
        let mut m = self.method_call_with_args(
            &"org.bluez.Media1".into(),
            &"RegisterEndpoint".into(),
            |msg| {
                let mut i = arg::IterAppend::new(msg);
                i.append(endpoint);
                i.append(properties);
...
impl<'a, C: ::std::ops::Deref<Target = dbus::Connection>> OrgBluezNetworkServer1
    for dbus::ConnPath<'a, C>
{
    type Err = dbus::Error;
