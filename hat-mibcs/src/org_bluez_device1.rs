...
pub trait OrgBluezDevice1 {
    ...
    fn get_manufacturer_data(
        &self,
    ) -> Result<::std::collections::HashMap<u16, arg::Variant<Box<arg::RefArg>>>, Self::Err>;
    fn get_service_data(
        &self,
...
impl<'a, C: ::std::ops::Deref<Target = dbus::Connection>> OrgBluezDevice1
    for dbus::ConnPath<'a, C>
{
    type Err = dbus::Error;
    ...
    fn disconnect(&self) -> Result<(), Self::Err> {
        let mut m =
            self.method_call_with_args(&"org.bluez.Device1".into(), &"Disconnect".into(), |_| {})?;
        m.as_result()?;
        Ok(())
    }
    ...
    fn connect(&self) -> Result<(), Self::Err> {
        let mut m =
            self.method_call_with_args(&"org.bluez.Device1".into(), &"Connect".into(), |_| {})?;
        m.as_result()?;
        Ok(())
    }
    ...
    fn pair(&self) -> Result<(), Self::Err> {
        let mut m =
            self.method_call_with_args(&"org.bluez.Device1".into(), &"Pair".into(), |_| {})?;
        m.as_result()?;
        Ok(())
    }
